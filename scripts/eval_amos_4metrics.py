#!/usr/bin/env python3
"""Evaluate SKCDF AMOS test set with DSC, HD95, NSD, ASD (ECCV convention)."""
import argparse
import os
import sys
...
def main():
    ...
    parser.add_argument('--exp', type=str, default='amos_5p/skcdf/fold1')
    ...
    print(f'test volumes: {len(ids_list)}')
    ...
    with open(out_path, 'w', encoding='utf-8') as fw:
        ...
        print(header)
        print('-' * 50)
        for ci, cname in enumerate(AMOS_CLASS_NAMES):
            row = (
